  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.details}>
        <Detail label="Preço atual" value={`R$ ${data.currentPrice.toFixed(2)}`} />
        <Detail label="Valor patrimonial" value={`R$ ${data.bookValuePerShare.toFixed(2)}`} />
        <Detail label="VP em cache" value={data.bookValueFromCache ? 'Sim' : 'Não'} />
      </div>
